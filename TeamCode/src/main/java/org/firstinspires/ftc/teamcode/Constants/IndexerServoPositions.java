...
@Configurable
public final class IndexerServoPositions {
    ...
    public static double FRONT_GATE_CLOSED = 1.0;
    public static double FRONT_GATE_OPEN = 0.0;

    public static double BACK_GATE_CLOSED = 0.6;
    public static double BACK_GATE_OPEN = 0.3;

    private IndexerServoPositions() {
    }
}
