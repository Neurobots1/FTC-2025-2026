...
public class ShooterConstants {
    ...
    public static double chassisAimKd = 0.18;
    public static double chassisAimMaxTurnCommand = 0.65;
    public static double chassisAimDeadbandDeg = 0.60;
    public static double chassisAimTargetFilterGain = 0.18;
    public static double chassisAimMaxCommandStepPerSecond = 3.0;
