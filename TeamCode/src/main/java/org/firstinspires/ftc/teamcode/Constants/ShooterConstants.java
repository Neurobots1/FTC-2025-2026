...
public class ShooterConstants {
    ...
    public static double shot9DistanceInches = 132.0;
    public static double shot9TargetRpm = 3820.0;
    public static double shot9HoodAngleDeg = 31.5;

    public static double shot10DistanceInches = 144.0;
    public static double shot10TargetRpm = 3960.0;
    public static double shot10HoodAngleDeg = 30.5;

    public static double shot11DistanceInches = 156.0;
    public static double shot11TargetRpm = 4090.0;
    public static double shot11HoodAngleDeg = 30.0;

    public static double shot12DistanceInches = 168.0;
    public static double shot12TargetRpm = 4220.0;
    public static double shot12HoodAngleDeg = 30.0;
