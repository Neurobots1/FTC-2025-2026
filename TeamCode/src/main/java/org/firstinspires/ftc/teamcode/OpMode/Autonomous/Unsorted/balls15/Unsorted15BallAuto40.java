...
public abstract class Unsorted15BallAuto40 extends BaseUnsortedAutoTemplate {
    ...
    public static class Blue extends Unsorted15BallAuto40 {
        @Override
    ...
    public static class Red extends Unsorted15BallAuto40 {
        @Override
        protected AutoAlliance alliance() {
