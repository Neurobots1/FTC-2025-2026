...
import org.firstinspires.ftc.teamcode.SubSystem.Vision.ConvertToPedroPose;
...
@Configurable
//@TeleOp
public class Teleop_Red_12_01_26 extends OpMode {
    ...
    private static final double GOAL_X = 136;
    private static final double GOAL_Y = 136;

    private Teleop_Red_12_01_26.ShooterTicksLUT shooterLUT = new Teleop_Red_12_01_26.ShooterTicksLUT();
    ...
    private static class ShooterTicksLUT {
        ...
        private final Teleop_Red_12_01_26.ShooterTicksLUT.CubicHermiteInterpolator hermite;

        ShooterTicksLUT() {
            hermite = new Teleop_Red_12_01_26.ShooterTicksLUT.CubicHermiteInterpolator(distances, ticks);
        }
