...
public class ModularAutoBuilder {
    ...
    public ModularAutoBuilder lockSortPattern(AprilTagPipeline aprilTag, double timeoutSeconds, SortPattern fallbackPattern) {
        steps.add(robot.lockSortPattern(aprilTag, timeoutSeconds, fallbackPattern));
        return this;
    }

    public ModularAutoBuilder readSortPattern(AprilTagPipeline aprilTag, double timeoutSeconds, SortPattern fallbackPattern) {
        return lockSortPattern(aprilTag, timeoutSeconds, fallbackPattern);
    }
